...
class NotificationService {
  ...
  void createScheduledAndroidNotification(int taskId, String taskName, String dueDate) async {
    const AndroidNotificationDetails androidPlatformChannelSpecifics =
    AndroidNotificationDetails(
        '1',
        'TaskSweeper',
        'One of your tasks is about to expire!',
    ...
    await flutterLocalNotificationsPlugin.zonedSchedule(
        ...
        tz.TZDateTime.parse(tz.local, dueDate).subtract(const Duration(days: 1)),
  ...
  Future<bool> hasScheduledAndroidNotification(int taskId) async {
    ...
    return pendingNotificationRequests.where((notification) => notification.id == taskId).length == 1;
  }
