...
class Account_StatusRepository {
    ...
    suspend fun deleteAccount_Status(accountname: String) = transaction{
        Account_Status.deleteWhere {
            Account_Status.username eq accountname
        }
    }
    ...
    suspend fun selectAccount_Status(username: String) = transaction {
